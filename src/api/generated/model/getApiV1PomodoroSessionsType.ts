...
export type GetApiV1PomodoroSessionsType =
    (typeof GetApiV1PomodoroSessionsType)[keyof typeof GetApiV1PomodoroSessionsType];

export const GetApiV1PomodoroSessionsType = {
    focus: 'focus',
