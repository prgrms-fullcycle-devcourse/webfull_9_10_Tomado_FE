 ...
 */
import type { PostApiV1PomodoroSessionsBodyType } from './postApiV1PomodoroSessionsBodyType';

export type PostApiV1PomodoroSessionsBody = {
    type: PostApiV1PomodoroSessionsBodyType;
};
