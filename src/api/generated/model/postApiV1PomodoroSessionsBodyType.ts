...
export type PostApiV1PomodoroSessionsBodyType =
    (typeof PostApiV1PomodoroSessionsBodyType)[keyof typeof PostApiV1PomodoroSessionsBodyType];

export const PostApiV1PomodoroSessionsBodyType = {
    focus: 'focus',
